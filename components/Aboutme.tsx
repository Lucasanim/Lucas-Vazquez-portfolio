  ...
  return (
    <div className="wrapper">
      ...
      <div className="text-lg tracking-wide flex flex-col gap-6">
        <p>
          I am a software engineer with strong experience with React and Spring Boot. I have a
          ...
          integrating with several micro services, and implementing responsive design
          ...
          skills, I am a strong communicator, being able to assist and cooperate with teammates from different
          countries and cultures in the leading role. I am able to work
